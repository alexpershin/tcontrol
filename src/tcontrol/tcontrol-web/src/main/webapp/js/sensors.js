...
function loadDataFromServer() {
    $.post("http://"+window.location.host+"/sensors",
...
function loadValuesFromServer() {
    $.post("http://"+window.location.host+":/sensor_values",
...
function onOffSensorRenderer(sensorElementId, sensor) {
    ...
    sensorElement.click(function (ev) {
        ...
        let onOffUrl = "";
        if (value === "Off") {
            onOffUrl = 'http://'+window.location.host+'/start_process';
        } else if (value === "On") {
            onOffUrl = 'http://'+window.location.host+'/stop_process';
        }
