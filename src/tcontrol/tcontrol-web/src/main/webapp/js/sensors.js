...
function loadDataFromServer() {
    $.post("http://"+window.location.host+"/tcontrol/sensors",
...
function loadValuesFromServer() {
    $.post("http://"+window.location.host+":/tcontrol/sensor_values",
...
function onOffSensorRenderer(sensorElementId, sensor) {
    ...
    sensorElement.click(function (ev) {
        ...
        let onOffUrl = "";
        if (value === "Off") {
            onOffUrl = 'http://'+window.location.host+'/tcontrol/start_process';
        } else if (value === "On") {
            onOffUrl = 'http://'+window.location.host+'/tcontrol/stop_process';
        }
